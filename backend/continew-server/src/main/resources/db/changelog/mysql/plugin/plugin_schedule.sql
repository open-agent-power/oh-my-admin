...
VALUES
(8000, '任务调度', 0, 1, '/schedule', 'Schedule', 'Layout', '/schedule/log', 'schedule', b'0', b'0', b'0', NULL, 8, 1, 1, NOW()),
(8020, '任务日志', 8000, 2, '/schedule/log', 'ScheduleLog', 'schedule/log/index', NULL, 'find-replace', b'0', b'0', b'0', NULL, 1, 1, 1, NOW()),
